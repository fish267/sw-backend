 ...
 * @version 1.0
 */
public class CompanyOrderDetailWrapper extends BaseTableWrapper<CompanyOrderDetailEntity>{

	public CompanyOrderDetailWrapper(IPage<CompanyOrderDetailEntity> pageResult) {
		//父类中的方法初始化数据
		super(pageResult);
